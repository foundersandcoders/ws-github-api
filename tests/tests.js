...
QUnit.test("success_contributorDetails takes an object and a json string and returns a copy of the object with the contributors property added", function(assert) {
  var obj = {
    userDetails: {
      img: 'https://avatars.githubusercontent.com/u/17532458?v=3',
      repos: 2,
